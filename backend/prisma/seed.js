...
const permissionsData = [
  ...
  { name: 'product:verify', description: 'Approve or reject product verification' },
...
const rolePermissionsMap = {
  PlatformAdmin: [
    ...
    'product:create', 'product:view', 'product:update', 'product:delete', 'product:archive', 'product:verify', 'product:manage-images', 'product:manage-documents', 'product:manage-categories', 'product:view-statistics',
